...
const climatehelp: Note = {
  ...
  sections: [
    ...
    { heading: 'next', body: 'previously newclear.website: subpage of cli-mate.help. acts as an interactive info hub for nuclear electricity education. demystifying nuclear goos and danger myths.', checklist: true },
